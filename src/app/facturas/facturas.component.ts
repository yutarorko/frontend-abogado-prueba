...
export class FacturasComponent implements OnInit {
  ...
  create():void{
    ...
    //this.facturaService.validarFactura(this.factura.serie + "-t" +this.factura.numeroBoleta).subscribe(n=>{
      //if(n == 0){
        if(this.factura.serie && this.factura.formaPago){
          this.factura.tipo = "tramite";
          ...
          //this.factura.numeroBoleta = this.factura.serie + "-t" + this.factura.numeroBoleta;
